...
const navigate = useNavigate()
    ...
    const PgDiploma = ['PG Diploma in Pharmacy Assistant','PG Diploma in Radiology Technician','PG Diploma in Phlebotomy Technician','PG Diploma in Vision Technician']
